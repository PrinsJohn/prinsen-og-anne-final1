...
sprites.onOverlap(SpriteKind.Player, SpriteKind.dør_lvl_1, function (sprite, otherSprite) {
    hjælpe_prik = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
    ...
    Prins.setPosition(78, 64)
    hjælpe_prik.setPosition(78, 64)
    hjælpe_prik.follow(Prins)
    game.splash("Du er nu videre til level 2")
})
function Skelet () {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Hjælp, function (sprite, otherSprite) {
    fjern_skelet()
})
function Intro_til_rejse_3 () {
    ...
    pause(5000)
    story.printText("Den første udfordring Prins " + Navn + " stødte på var.....", 0, 0)
    pause(5000)
...
function Intro_til_rejse_del_4 () {
    story.printText("Første udfordring var nu klaret", 50, 50)
    scene.setBackgroundImage(img`
        
    ...
    story.spriteMoveToLocation(Prins, 170, 98, 10)
    pause(5000)
    story.spriteSayText(Prins, "Nu skal jeg bare stå ansigt til ansigt med Dlop")
    sprites.destroy(Prins)
}
...
info.onLifeZero(function () {
    game.setGameOverMessage(false, "GAME OVER! Prøv igen :)")
    game.gameOver(false)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player)
    sprites.destroyAllSpritesOfKind(SpriteKind.Enemy)
    Final_boss()
...
function Intro_til_final_boss () {
    scene.setBackgroundImage(img`
        ...
        `)
    story.printText("Prinsen stod nu overfor Troldmand Dlop", 50, 50)
    Prins = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
...
function DlopOutro () {
    ...
    pause(1000)
    story.printText("Prinsen og Prinsessen levede lykkeligt til de gik på pension og blev trætte af hinanden. ", 10, 60, 15)
    pause(5000)
